...
$ConfiguratorAppUrl = 'https://configappstorage2008.file.core.windows.net/fs1/Configurator-App-for-Azure-Local-Setup-2508.0.3009.exe?sp=r&st=2025-09-15T22:30:49Z&se=2025-10-31T06:45:00Z&spr=https&sv=2024-11-04&sig=zavQ3jk2T9Et6RBt9rjXN5Om6J4ZPmkPoJNHj72o0dc%3D&sr=f'
Invoke-WebRequest -Uri $ConfiguratorAppUrl -OutFile "$($LocalBoxConfig.Paths['ConfiguratorDir'])\ConfiguratorApp.exe"
